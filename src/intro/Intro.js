    ...
    return (
        <div className="dark-green-theme container-padding-2em">
            <Container textAlign="center">
                ...
                <p>Vi ser väldigt mycket fram att fira vår stora dag tillsammans med er vi tycker om allra mest!</p>
                <br />
                <p>Det blir en helghelg med start på fredag för alla som kan där vi planerar för ett trevligt häng och grillkväll.</p>
